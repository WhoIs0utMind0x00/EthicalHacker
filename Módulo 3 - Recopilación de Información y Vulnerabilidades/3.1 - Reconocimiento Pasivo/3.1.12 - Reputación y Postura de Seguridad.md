# 3.1.12 - Reputación de la Empresa y Postura de Seguridad
...
Megapixels                      : 4.0
```
### Análisis/enumeración estratégicos del motor de búsqueda
...
GHDB es un esfuerzo de la comunidad. Cualquiera puede cargar un nuevo dork de Google para realizar este tipo de búsquedas. Una vez que comiences a jugar con los dorks en GHDB, te sorprenderán las cosas increíbles que se encuentran a través de la piratería de Google. GHDB ha hecho que usar Google dorks sea muy fácil, y también hay otras opciones. Más adelante en este módulo, aprenderá sobre herramientas adicionales que se pueden utilizar para realizar búsquedas similares (como Recon-ng).<br>
<hr>

### Archivado/almacenamiento de caché de sitios web
Varias organizaciones archivan y almacenan en caché datos de sitios web de Internet. Uno de los repositorios más populares es la "[Wayback Machine](https://archive.org/web)" de Internet Archive.<br>
Wayback Machine le permite retroceder en el tiempo en Internet. Por ejemplo, la siguiente imagen muestra el aspecto del sitio web de Cisco el 3 de noviembre de 1999. Puede acceder al archivo del sitio copiando el siguiente enlace en la barra de direcciones de su navegador: _https://web.archive.org/web/19991103121048/http://www.cisco.com/_.<br>

<img src="img/wayback.png" width="75%" height="75%" style="border-radius:10px;"><br>

### Repositorios de código fuente público
Un atacante puede obtener información extremadamente valiosa de repositorios de código fuente público como GitHub y GitLab. La mayoría de las aplicaciones y los productos que consumimos en la actualidad utilizan software de código abierto que está disponible de forma gratuita en estos repositorios públicos. Los atacantes pueden encontrar vulnerabilidades en esos paquetes de software y utilizarlos para su beneficio. De manera similar, como evaluador de penetración, puede obtener información valiosa de estos repositorios públicos. Incluso si no encuentra inmediatamente las vulnerabilidades de seguridad en el código, estos repositorios pueden brindarle información sobre la arquitectura y el código subyacente utilizado en las aplicaciones y la infraestructura de la organización.<br>
