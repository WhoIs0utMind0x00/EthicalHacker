...
<img src="Imagenes/Secuestro_Sesion.jpeg" width="20%" height="20%" style="border-radius:10px;"><br>
...
<img src="Imagenes/Captura_Wireshark.png" width="40%" height="40%" style="border-radius:10px;"><br>
