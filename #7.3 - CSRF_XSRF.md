# Ataques de Falsificación de Solicitudes entre Sitios (CSRF/XSRF) y de Falsificación de Solicitudes del Lado del Servidor
...
<img src="Imagenes/CSRF.png" width="75%" height="75%" style="display:flex; border-radius:10px;"><br>
