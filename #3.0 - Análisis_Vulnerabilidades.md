# Funcionamiento de un escáner de vulnerabilidades automatizado

<img src="Imagenes/escaner-vuln.jpeg" width="50%" height="50%" style="border-radius:10px;"><br>


__Paso 1__: En la fase de detección, el escáner utiliza una herramienta como Nmap para realizar la enumeración de hosts y puertos. Con los resultados de la enumeración de hosts y puertos, el escáner comienza a sondear los puertos abiertos para obtener más información.

__Paso 2__: Cuando el escáner tiene suficiente información sobre el puerto abierto para determinar qué software y versión se están ejecutando en ese puerto, registra esa información en una base de datos para su posterior análisis. El escáner puede utilizar varios métodos para tomar esta determinación, incluido el uso de información de anuncios.

__Paso 3__: El escáner intenta determinar si el software que escucha en el sistema de destino es susceptible a vulnerabilidades conocidas. Lo hace correlacionando una base de datos de vulnerabilidades conocidas con la información registrada en la base de datos sobre los servicios objetivo.

__Paso 4__: El escáner produce un informe sobre lo que sospecha que podría ser vulnerable. Tenga en cuenta que estos resultados suelen ser falsos positivos y deben validarse. Como mínimo, este tipo de herramienta le da una idea de dónde buscar vulnerabilidades que puedan aprovecharse.
...
__Escaneos no autenticados__<br>
...
<img src="Imagenes/escaner_pasivo.jpeg" width="35%" height="35%" style="border-radius:10px; margin-left:5px;"><br>
...
__Escaneos de cumplimiento__<br>
