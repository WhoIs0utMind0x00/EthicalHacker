...
La siguiente imagen muestra un ejemplo de cómo se puede utilizar TrevorC2 como marco de comando y control. Esta imagen muestra dos ventanas de terminal. La ventana a la izquierda es el sistema atacante (servidor C2) y la ventana de la derecha es la víctima (cliente).<br>

<img src="img/TrevorC2.png" width="75%" height="75%" style="border-radius:10px;"><br>

__CONSEJO__: En The C2 Matrix se incluye una gran cantidad de herramientas de emulación adversarial y C2 de código abierto, junto con funciones compatibles, compatibilidad con implantes y otra información en https://www.thec2matrix.com/.
